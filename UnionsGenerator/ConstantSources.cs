...
internal static class ConstantSources
{
    public static String UnsafeConvert(String tFrom, String tTo, String valueExpression) =>
        $"(global::RhoMicro.CodeAnalysis.UnionsGenerator.Generated.Util.UnsafeConvert<{tFrom}, {tTo}>({valueExpression}))";
    public static String GetFullString(String typeExpression) =>
        $"(global::RhoMicro.CodeAnalysis.UnionsGenerator.Generated.Util.GetFullString({typeExpression}))";
