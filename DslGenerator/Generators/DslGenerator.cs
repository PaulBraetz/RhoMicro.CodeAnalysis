    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        var provider = context.AdditionalTextsProvider
            ...
            .Select((t, ct) =>
            {
                ...
                var comment = new StringBuilder().Append("    /// ").AppendDisplayString(ruleList).Replace("\n", "\n\t/// </c></para>\n\t/// <para><c>\n\t/// ").ToString();
                ...
                .Append(
                    """
                        ...
                        /// </summary>
                        public static 
                    """).Append(type).Append(' ').Append(name).AppendLine(" { get; } = ")
                .AppendMetaString(ruleList).AppendLine(";")
                .ToString();
            ...
            .Select((sourceTuples, ct) =>
            {
                ...
                var sourceBuilder = new StringBuilder("// <auto-generated>")
                    ...
                    .Append(
                    """
                    namespace RhoMicro.CodeAnalysis.DslGenerator.Grammar.Generated;

                    static class GeneratedRuleLists
                    {
